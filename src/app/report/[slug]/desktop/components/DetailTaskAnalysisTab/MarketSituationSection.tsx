...
interface MarketSituationSectionProps {
...
function MarketSituationSection({ marketConditions, tipContent }: MarketSituationSectionProps) {
  return (
...
export default MarketSituationSection;
