...
function TrendAnalysisSection() {
  return (
    <div className="flex flex-col relative sm:flex-row px-4 sm:pl-[120px] sm:h-[661px] sm:pr-0 py-12 sm:py-0 items-center w-full bg-[#F5F5F5]">
      ...
      <div className="sm:absolute sm:top-[103px] sm:-right-[63.79px] flex justify-center items-center mt-[39px]">
        <Image
